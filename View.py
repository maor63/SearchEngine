...
class View(Observer):
    ...
    def display_summery_doc(self, summery):
        ...
        canvas['xscrollcommand'] = scroll_bar.set
        sentence = Label(canvas, text="sentence")
        rank = Label(canvas, text="Rank")
        sentence.grid(row=0, column=1)
        rank.grid(row=0, column=0)
        sentence_1 = Label(canvas, text=summery[0].replace("\n", ""))
        rank_1 = Label(canvas, text="5")
        sentence_1.grid(row=1, column=1,  sticky=W)
        rank_1.grid(row=1, column=0)
        sentence_2 = Label(canvas, text=summery[1].replace("\n", ""))
        rank_2 = Label(canvas, text="4")
        sentence_2.grid(row=2, column=1,  sticky=W)
        rank_2.grid(row=2, column=0)
        sentence_3 = Label(canvas, text=summery[2].replace("\n", ""))
        rank_3 = Label(canvas, text="3")
        sentence_3.grid(row=3, column=1, sticky=W)
        rank_3.grid(row=3, column=0)
        sentence_4 = Label(canvas, text=summery[3].replace("\n", ""))
        rank_4 = Label(canvas, text="2")
        sentence_4.grid(row=4, column=1, sticky=W)
        rank_4.grid(row=4, column=0)
        sentence_5 = Label(canvas, text=summery[4].replace("\n", ""))
        rank_5 = Label(canvas, text="1")
        sentence_5.grid(row=5, column=1, sticky=W)
        rank_5.grid(row=5, column=0)
        canvas.pack()

        canvas.grid(column=0, row=0, sticky=(N, W, E, S))
        scroll_bar.grid(column=0, row=1, sticky=(W, E))
